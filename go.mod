module github.com/condemo/nes-cards
...
require (
	...
	github.com/uptrace/bun/dialect/sqlitedialect v1.2.7 // indirect
	github.com/uptrace/bun/driver/sqliteshim v1.2.7 // indirect
